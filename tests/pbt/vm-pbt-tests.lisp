...
(defproperty vm-const-roundtrip
  ...
  (let* ((original (make-instance 'vm-const :dst :r0 :value val))
...
(defproperty vm-move-roundtrip
  ...
  (let* ((dummy dummy)  ; suppress unused warning
         (original (make-instance 'vm-move :dst :r0 :src :r1))
         (sexp (instruction->sexp original))
         (restored (sexp->instruction sexp)))
...
(defproperty vm-add-roundtrip
    (dummy (gen-integer :min 0 :max 0))
  (let* ((dummy dummy)  ; suppress unused warning
         (original (make-instance 'vm-add :dst :r0 :lhs :r1 :rhs :r2))
         (sexp (instruction->sexp original))
         (restored (sexp->instruction sexp)))
...
(defproperty vm-const-sets-register
  ...
  (let* ((state (make-instance 'vm-state))
         (inst (make-instance 'vm-const :dst :r0 :value val)))
...
(defproperty vm-move-copies-value
    (val (gen-integer :min -1000 :max 1000))
  (let* ((state (make-instance 'vm-state))
         (const-inst (make-instance 'vm-const :dst :r0 :value val))
         (move-inst (make-instance 'vm-move :dst :r1 :src :r0)))
...
(defproperty vm-add-computes-sum
  ...
  (let* ((state (make-instance 'vm-state))
         (inst-a (make-instance 'vm-const :dst :r0 :value a))
         (inst-b (make-instance 'vm-const :dst :r1 :value b))
         (inst-add (make-instance 'vm-add :dst :r2 :lhs :r0 :rhs :r1)))
...
(defproperty vm-sub-computes-difference
  ...
  (let* ((state (make-instance 'vm-state))
         (inst-a (make-instance 'vm-const :dst :r0 :value a))
         (inst-b (make-instance 'vm-const :dst :r1 :value b))
         (inst-sub (make-instance 'vm-sub :dst :r2 :lhs :r0 :rhs :r1)))
    (execute-instruction inst-a state 0 (make-hash-table))
    (execute-instruction inst-b state 1 (make-hash-table))
...
(defproperty vm-mul-computes-product
  ...
  (let* ((state (make-instance 'vm-state))
         (inst-a (make-instance 'vm-const :dst :r0 :value a))
         (inst-b (make-instance 'vm-const :dst :r1 :value b))
         (inst-mul (make-instance 'vm-mul :dst :r2 :lhs :r0 :rhs :r1)))
    (execute-instruction inst-a state 0 (make-hash-table))
    (execute-instruction inst-b state 1 (make-hash-table))
