...
(deftest-each binary-fold-table-arithmetic-ops-registered
  ...
  :cases (("vm-add"        'vm-add)
          ...
          ("vm-lcm"        'vm-lcm))
  (type-sym)
  (assert-true (gethash type-sym cl-cc::*opt-binary-fold-table*)))
...
(deftest binary-fold-table-add-function-evaluates-correctly
  ...
  (let ((fn (gethash 'vm-add cl-cc::*opt-binary-fold-table*)))
    (assert-true fn)
...
(deftest binary-fold-table-sub-function-evaluates-correctly
  ...
  (let ((fn (gethash 'vm-sub cl-cc::*opt-binary-fold-table*)))
...
(deftest binary-fold-table-mul-function-evaluates-correctly
  ...
  (let ((fn (gethash 'vm-mul cl-cc::*opt-binary-fold-table*)))
...
(deftest-each binary-cmp-fold-table-ops-registered
  ...
  :cases (("vm-lt"     'vm-lt)
          ...
          ("vm-num-eq" 'vm-num-eq))
  (type-sym)
  (assert-true (gethash type-sym cl-cc::*opt-binary-cmp-fold-table*)))
...
(deftest binary-cmp-fold-table-lt-function-evaluates-correctly
  ...
  (let ((fn (gethash 'vm-lt cl-cc::*opt-binary-cmp-fold-table*)))
...
(deftest unary-fold-table-abs-evaluates-correctly
  ...
  (let ((fn (gethash 'vm-abs cl-cc::*opt-unary-fold-table*)))
...
(deftest unary-fold-table-not-nil-returns-t
  ...
  (let ((fn (gethash 'vm-not cl-cc::*opt-unary-fold-table*)))
...
(deftest-each type-pred-fold-table-ops-registered
  ...
  (type-sym)
  (assert-true (gethash type-sym cl-cc::*opt-type-pred-fold-table*)))

(deftest type-pred-fold-table-null-p-evaluates-correctly
  "The vm-null-p entry correctly identifies nil."
  (let ((fn (gethash 'vm-null-p cl-cc::*opt-type-pred-fold-table*)))
    (assert-true (funcall fn nil))
...
(deftest type-pred-fold-table-function-p-always-false-for-constants
  ...
  (let ((fn (gethash 'vm-function-p cl-cc::*opt-type-pred-fold-table*)))
...
(deftest foldable-binary-types-contains-arithmetic-types
  ...
  (assert-true (member 'vm-add cl-cc::*opt-foldable-binary-types*))
  (assert-true (member 'vm-lt  cl-cc::*opt-foldable-binary-types*))
  (assert-true (member 'vm-mul cl-cc::*opt-foldable-binary-types*)))
...
(deftest foldable-unary-types-contains-expected-types
  ...
  (assert-true (member 'vm-neg    cl-cc::*opt-foldable-unary-types*))
  (assert-true (member 'vm-null-p cl-cc::*opt-foldable-unary-types*))
  (assert-true (member 'vm-abs    cl-cc::*opt-foldable-unary-types*)))
...
(deftest binary-zero-guard-types-contains-division-ops
  ...
  (assert-true (member 'vm-div cl-cc::*opt-binary-zero-guard-types*))
  (assert-true (member 'vm-mod cl-cc::*opt-binary-zero-guard-types*))
  (assert-true (member 'vm-rem cl-cc::*opt-binary-zero-guard-types*)))
...
(deftest binary-no-fold-types-contains-floor-ceiling
  ...
  (assert-true (member 'vm-floor-inst   cl-cc::*opt-binary-no-fold-types*))
  (assert-true (member 'vm-ceiling-inst cl-cc::*opt-binary-no-fold-types*))
  (assert-true (member 'vm-truncate     cl-cc::*opt-binary-no-fold-types*))
  (assert-true (member 'vm-round-inst   cl-cc::*opt-binary-no-fold-types*)))

(deftest commutative-inst-types-contains-add-and-mul
  "*opt-commutative-inst-types* includes vm-add, vm-mul, vm-logand, vm-num-eq."
  (assert-true (member 'vm-add    cl-cc::*opt-commutative-inst-types*))
  (assert-true (member 'vm-mul    cl-cc::*opt-commutative-inst-types*))
  (assert-true (member 'vm-logand cl-cc::*opt-commutative-inst-types*))
  (assert-true (member 'vm-num-eq cl-cc::*opt-commutative-inst-types*)))
...
(deftest commutative-inst-types-excludes-sub-and-div
  ...
  (assert-false (member 'vm-sub cl-cc::*opt-commutative-inst-types*)))
...
(deftest opt-inst-dst-returns-dst-register
  ...
  (let ((inst (make-vm-add :dst :r3 :lhs :r1 :rhs :r2)))
    (assert-eq :r3 (cl-cc::opt-inst-dst inst))))
...
(deftest opt-inst-dst-returns-nil-for-no-dst
  ...
  (let ((inst (make-vm-jump :label "end")))
    (assert-null (cl-cc::opt-inst-dst inst))))
...
(deftest opt-inst-read-regs-returns-nil-for-vm-const
  ...
  (let ((inst (make-vm-const :dst :r0 :value 42)))
    (assert-null (cl-cc::opt-inst-read-regs inst))))
...
(deftest opt-inst-read-regs-returns-src-for-vm-move
  ...
  (let ((inst (make-vm-move :dst :r1 :src :r0)))
    (assert-equal '(:r0) (cl-cc::opt-inst-read-regs inst))))
