...
(asdf:defsystem :cl-cc
  ...
  ((:module "src"
   ...
   (:module "expand"
    :pathname "packages/frontend/expand/src"
    :serial t
    :components
   ...
   (:module "compile"
    :pathname "packages/engine/compile/src"
    :serial t
    :components
   ...
   (:module "optimize"
    :pathname "packages/engine/optimize/src"
    :serial t
    :components
   ...
   (:module "emit"
    :pathname "packages/backend/emit/src"
    :serial t
    :components
  ...
  ((:module "framework"
   ...
   (:module "bytecode-tests"
    ...
    ((:file "encode-tests")
     ...
     (:file "decode-tests")))
   (:file "tests/unit/migration-safety-tests")
   (:module "integration"
