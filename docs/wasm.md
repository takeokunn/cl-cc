...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/emit/src/wasm-types.lisp`
...
- **対象**: `packages/emit/src/wasm-types.lisp`, `packages/vm/src/vm-clos.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/list.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/runtime/src/heap.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, 数値演算エミッタ
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, 型述語エミッタ
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/expand/src/macros-stdlib.lisp`
...
- **対象**: `packages/vm/src/strings.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/emit/src/wasm.lisp`
...
- **対象**: `packages/optimize/src/optimizer.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/vm/src/vm.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/vm.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/emit/src/wasm.lisp`, `packages/vm/src/vm.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/vm/src/list.lisp`, `packages/vm/src/strings.lisp`
...
- **対象**: `packages/vm/src/primitives.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/primitives.lisp`
...
- **対象**: `packages/compile/src/codegen.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/runtime/src/heap.lisp`, `packages/emit/src/wasm.lisp`
- **現状**: Wasm のメモリページサイズは固定 64KB。CL の小オブジェクト主体のヒープには粒度が粗すぎる
- **内容**: Wasm Custom Page Sizes Proposal（Phase 3、2024年）でページサイズを `4096`（4KB）または `1`（1B）に設定可能。GC ヒープを 4KB ページで管理し、`memory.grow` の最小単位を OS の mmap と揃える。世代別GC（`packages/runtime/src/gc.lisp`）のページビットマップが 16倍細粒度化
...
- **対象**: `packages/runtime/src/gc.lisp`, `packages/emit/src/wasm.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, FR-227 の動的リンク基盤
...
- **対象**: `packages/emit/src/wasm.lisp`, SIMD エミッタ
...
- **対象**: `packages/emit/src/wasm.lisp`, 浮動小数点エミッタ
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/array.lisp`
...
- **対象**: `packages/vm/src/strings.lisp`, `packages/vm/src/array.lisp`
- **現状**: Wasm GC 配列の要素アクセスは `array.get` で1要素ずつ。文字列スキャン・シリアライザは ループで複数要素を個別取得
- **内容**: Wasm Multibyte Array Access Proposal（Phase 1）の `array.load2_u`（2要素を i32 にパック）/ `array.load4_u`（4要素を i32 に）/ `array.store2`/`array.store4` を使用。UTF-16 文字列操作・バイナリシリアライゼーション（Mach-O builder `packages/binary/src/macho.lisp` 等）でアクセス命令数を 1/2〜1/4 に削減
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/conditions.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/compile/src/cps.lisp`
...
- **根拠**: CPS 変換（`packages/compile/src/cps.lisp`）後のコードは継続への末尾呼び出しが支配的。`return_call_ref` なしでは深い再帰がスタック枯渇する
- **難易度**: Medium
...
- **対象**: `packages/vm/src/conditions.lisp`, `packages/runtime/src/gc.lisp`, `packages/emit/src/wasm.lisp`
...
- **対象**: `packages/runtime/src/gc.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/vm/src/io.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/optimize/src/optimizer.lisp`
...
- **対象**: `packages/optimize/src/optimizer.lisp`, `packages/emit/src/wasm.lisp`
...
- **対象**: `packages/vm/src/conditions.lisp`, `packages/emit/src/wasm-trampoline.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/vm-clos.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/vm/src/io.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/emit/src/wasm-types.lisp`, `packages/vm/src/vm.lisp`
...
- **対象**: `packages/emit/src/wasm-types.lisp`, `packages/vm/src/strings.lisp`
...
- **対象**: `packages/emit/src/wasm-trampoline.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/emit/src/wasm.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/vm/src/primitives.lisp`, `packages/emit/src/wasm.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, `packages/vm/src/conditions.lisp`
...
- **対象**: `packages/emit/src/wasm.lisp`, SIMD エミッタ, `tests/unit/vm/primitives-tests.lisp`
