...
| SBCL `deftransform` (メソッド特化変換) | ✅    | ✅   | 備考: F10 — *deftransform-table*, define-deftransform, compiler-macroexpand連携
...
| sealed classes             | ✅    | ✅   | 備考: F7a — :__sealed__フラグ, subclass/redefinition拒否, define-sealed-type
| satiated generic functions | ✅    | ✅   | 備考: F8 — :__satiated__フラグ, permanent IC cache, register-methodでunsatiate
