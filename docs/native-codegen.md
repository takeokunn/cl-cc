...
- **対象**: `packages/backend/runtime/src/value.lisp` + `packages/backend/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/engine/vm/src/vm.lisp` の `vm-dispatch-generic-call`
...
- **内容**:
  - MIR層 (`packages/foundation/mir/src/mir.lisp`) はSSA CFGインフラが完備しているが本番パイプラインから切断されている
...
- **対象**: `packages/engine/vm/src/vm.lisp` (IC計測) + コンパイルパイプライン
- **内容**:
...
- **対象**: `packages/engine/vm/src/vm.lisp:260-291`, `packages/engine/compile/src/codegen.lisp`
...
- **対象**: `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/emit/src/wasm.lisp`
...
- **対象**: `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/emit/src/x86-64-encoding.lisp`
...
- **対象**: `packages/backend/emit/src/x86-64.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/emit/src/aarch64-codegen.lisp`
...
- **対象**: `packages/backend/runtime/src/heap.lisp`, `packages/engine/compile/src/codegen-clos.lisp`
...
- **対象**: `packages/engine/optimize/src/cfg.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`
...
- **対象**: 新規`packages/backend/binary/src/pe.lisp`
...
- **対象**: `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/emit/src/x86-64.lisp`
...
- **対象**: `packages/backend/emit/src/aarch64-codegen.lisp`, `packages/backend/emit/src/aarch64.lisp`
...
- **対象**: 新規`packages/backend/emit/src/riscv64-codegen.lisp`, `packages/foundation/mir/src/target.lisp`
...
- **対象**: `packages/backend/emit/src/x86-64.lisp`, `packages/backend/emit/src/aarch64.lisp`, `packages/backend/emit/src/wasm.lisp`
...
- **対象**: 新規`packages/backend/emit/src/isel/x86-64-rules.lisp`, `packages/backend/emit/src/isel/aarch64-rules.lisp`, `packages/foundation/mir/src/mir.lisp`
...
- **対象**: `packages/backend/binary/src/macho.lisp`, `packages/backend/binary/src/elf.lisp`, `packages/backend/emit/src/wasm.lisp`
...
- **対象**: `packages/backend/emit/src/calling-convention.lisp`
