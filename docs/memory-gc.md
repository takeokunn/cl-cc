...
- **対象**: `src/runtime/value.lisp`, `src/vm/vm.lisp`
...
- **対象**: `src/runtime/heap.lisp`, `src/emit/x86-64-codegen.lisp`
...
- **対象**: `src/compile/codegen.lisp`, `src/expand/expander.lisp`, `src/compile/cps.lisp`
...
- **対象**: `src/emit/x86-64-codegen.lisp`, `src/emit/mir.lisp`
...
- **対象**: `src/runtime/heap.lisp`, `src/emit/aarch64.lisp`
...
- **対象**: `src/backend/wasm.lisp` (新規: `src/backend/wasm-gc.lisp`)
...
- **対象**: `src/runtime/gc.lisp`, `src/vm/strings.lisp`
...
- **対象**: `src/vm/strings.lisp`, `src/runtime/gc.lisp`
...
- **対象**: `src/vm/vm.lisp`, `src/runtime/heap.lisp`, `src/runtime/gc.lisp`
...
- **対象**: `src/runtime/gc.lisp`, `src/optimize/optimizer.lisp`
...
- **対象**: `src/runtime/gc.lisp`, `src/emit/x86-64-codegen.lisp`, `src/emit/aarch64.lisp`
...
- **対象**: `src/vm/vm-clos.lisp`, `src/runtime/heap.lisp`, `src/compile/codegen.lisp`
...
- **対象**: `src/vm/vm-clos.lisp`, `src/runtime/gc.lisp`
...
- **対象**: `src/runtime/gc.lisp`, `src/type/` (HMシステム)
...
- **対象**: `src/compile/cps.lisp`, `src/runtime/gc.lisp`
- **現状**: cl-ccはCPS変換（`src/compile/cps.lisp`）で全関数をcontinuation-passing styleに変換。継続オブジェクトは通常クロージャとしてヒープ割り当て
...
- **対象**: `src/runtime/heap.lisp`, `src/runtime/gc.lisp`, `src/cli/main.lisp`
...
- **対象**: `src/vm/io.lisp`, `src/runtime/gc.lisp`
...
- **対象**: `src/package.lisp`, `src/runtime/gc.lisp`
