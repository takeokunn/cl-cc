...
- **対象**: `packages/vm/src/conditions.lisp`, `packages/parse/src/cl/parser.lisp`
- **内容**:
...
- **対象**: `packages/parse/src/lexer.lisp`, `packages/vm/src/strings.lisp`
- **内容**:
...
- **対象**: `packages/vm/src/vm.lisp`, `packages/parse/src/lexer.lisp`
- **内容**:
...
- **対象**: `packages/vm/src/vm.lisp` (新規: `packages/vm/src/bytecode.lisp`)
- **内容**:
