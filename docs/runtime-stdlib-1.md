...
- **対象**: `packages/vm/src/strings.lisp`, `packages/vm/src/primitives.lisp`
...
- **対象**: 新ファイル `packages/vm/src/regex.lisp`
...
- **対象**: `packages/parse/src/cl/parser.lisp`, `packages/compile/src/codegen.lisp`, `packages/vm/src/conditions.lisp`
...
- **対象**: `packages/vm/src/conditions.lisp`, エラー出力系
- **依存**: FR-677, FR-678
- **内容**:
  - Rustスタイルのエラー表示:
    ```
...
- **対象**: 新ファイル `packages/runtime/src/serialize.lisp`
- **内容**:
...
- **対象**: 新ファイル `packages/vm/src/json.lisp`
- **内容**:
...
- **対象**: `packages/vm/src/vm-run.lisp`, `src/debug/`
- **内容**:
...
- **対象**: `packages/vm/src/vm-run.lisp`, `packages/vm/src/conditions.lisp`
...
- **対象**: `packages/runtime/src/os.lisp`
- **内容**:
...
- **対象**: `packages/vm/src/strings.lisp`, `packages/vm/src/format.lisp`
...
- **対象**: `packages/vm/src/unicode.lisp` (FR-592)
- **依存**: FR-592, FR-710
- **内容**:
...
- **対象**: `packages/cli/src/main.lisp`, `packages/runtime/src/os.lisp`
...
- **対象**: 新ファイル `packages/runtime/src/crypto.lisp`
- **内容**:
...
- **対象**: `packages/runtime/src/crypto.lisp`
- **内容**:
...
- **対象**: `packages/runtime/src/compress.lisp`
- **内容**:
...
- **対象**: 新ファイル `packages/vm/src/persistent.lisp`
- **内容**:
...
- **対象**: `packages/vm/src/persistent.lisp`
- **内容**:
...
- **対象**: 新ファイル `packages/runtime/src/event-loop.lisp`
- **内容**:
...
- **対象**: `packages/runtime/src/event-loop.lisp`
- **内容**:
...
- **対象**: 新ファイル `packages/runtime/src/stm.lisp`
- **内容**:
...
- **対象**: `packages/runtime/src/stm.lisp`
- **依存**: FR-771
- **内容**:
...
- **対象**: 新ファイル `packages/runtime/src/channel.lisp`
- **依存**: FR-552（グリーンスレッド）
- **内容**:
...
- **対象**: `packages/runtime/src/channel.lisp`
- **依存**: FR-552
- **内容**:
...
- **対象**: 新ファイル `packages/runtime/src/effects.lisp`
- **内容**:
...
- **対象**: `packages/runtime/src/effects.lisp`
- **依存**: FR-783
- **内容**:
