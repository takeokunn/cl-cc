...
- **対象**: `packages/engine/vm/src/vm-run.lisp`, `packages/backend/runtime/src/gc.lisp`
...
- **対象**: `packages/engine/vm/src/vm-clos.lisp`, `packages/engine/vm/src/vm-execute.lisp`
- **内容**:
...
- **対象**: `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/engine/vm/src/vm.lisp`
- **内容**:
...
- **対象**: `packages/engine/vm/src/primitives.lisp`, `packages/frontend/expand/src/macros-stdlib.lisp`
...
- **対象**: `packages/backend/runtime/src/runtime.lisp`, `packages/engine/vm/src/vm.lisp` (新ファイル `src/ffi/cffi.lisp`)
...
- **対象**: `packages/backend/binary/src/macho.lisp`, `packages/engine/compile/src/codegen.lisp`
...
- **対象**: `packages/backend/runtime/src/gc.lisp`, `packages/engine/vm/src/vm-run.lisp`
- **内容**:
...
- **対象**: `packages/engine/vm/src/vm.lisp` (`vm-intern-symbol`)
...
- **対象**: `packages/backend/runtime/src/runtime.lisp` (新ファイル `packages/backend/runtime/src/os.lisp`)
- **内容**:
...
- **対象**: 新ファイル `packages/backend/runtime/src/net.lisp`
- **内容**:
...
- **対象**: `packages/engine/vm/src/vm.lisp`, `packages/engine/vm/src/vm-run.lisp`
...
- **対象**: `packages/engine/vm/src/vm-run.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/engine/vm/src/strings.lisp`, `packages/engine/vm/src/vm.lisp` (新ファイル `packages/engine/vm/src/unicode.lisp`)
...
- **対象**: `packages/engine/vm/src/io.lisp` (新ファイル `packages/engine/vm/src/pathname.lisp`)
...
- **対象**: `packages/engine/vm/src/pathname.lisp` (FR-595)
- **依存**: FR-595
- **内容**:
...
- **対象**: `packages/engine/vm/src/io.lisp` (新ファイル `packages/engine/vm/src/stream.lisp`)
...
- **対象**: `packages/engine/vm/src/stream.lisp` (FR-600)
- **依存**: FR-600
- **内容**:
...
- **対象**: `packages/engine/vm/src/stream.lisp`
- **内容**:
...
- **対象**: `packages/engine/vm/src/io.lisp` (新ファイル `packages/engine/vm/src/pprint.lisp`)
...
- **対象**: `packages/engine/vm/src/io.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: `packages/frontend/parse/src/cl/lexer.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: `packages/engine/vm/src/vm.lisp` (新ファイル `packages/engine/vm/src/time.lisp`)
...
- **対象**: `packages/engine/vm/src/primitives.lisp` (新ファイル `packages/engine/vm/src/random.lisp`)
...
- **対象**: `packages/engine/vm/src/vm-run.lisp`, `packages/backend/runtime/src/runtime.lisp`
...
- **対象**: `packages/engine/vm/src/vm.lisp` (`vm-intern-symbol`, `vm-find-package`)
...
- **対象**: `packages/engine/vm/src/format.lisp` (または `packages/engine/vm/src/io.lisp`)
- **現状**: `~A`/`~S`/`~%`/`~&`/`~T` の基本実装のみ
- **内容**:
...
- **対象**: `packages/engine/vm/src/array.lisp`, `packages/engine/vm/src/list.lisp`
...
- **対象**: `packages/engine/vm/src/array.lisp`
...
- **対象**: `packages/engine/vm/src/io.lisp`, `packages/engine/vm/src/format.lisp`
...
- **対象**: `packages/engine/vm/src/conditions.lisp`, `packages/engine/vm/src/io.lisp`
- **内容**:
...
- **対象**: `packages/engine/vm/src/strings.lisp`, `packages/frontend/parse/src/cl/lexer.lisp`
...
- **対象**: `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/emit/src/aarch64-codegen.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: `packages/engine/vm/src/vm.lisp`, `packages/backend/runtime/src/` (新規 scheduler.lisp)
...
- **対象**: 新規`packages/backend/runtime/src/task.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: `packages/frontend/expand/src/macros-stdlib.lisp`, `packages/engine/vm/src/vm.lisp`, 新規`packages/backend/runtime/src/async.lisp`
- **現状**: 同期実行のみ。CPS変換（`packages/engine/compile/src/cps.lisp`）はあるが非同期スケジューリングと未接続
...
- **対象**: 新規`packages/backend/runtime/src/channel.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/future.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/actor.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/scheduler.lisp`（FR-257 scheduler.lisに統合可能）
...
- **対象**: 新規`packages/backend/runtime/src/stm.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: `packages/backend/runtime/src/stm.lisp`（FR-300依存）
- **現状**: FR-300の再試行戦略未定義
...
- **対象**: 新規`packages/backend/runtime/src/io-uring.lisp`, `packages/backend/runtime/src/runtime.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/event-loop.lisp`
...
- **対象**: `packages/backend/runtime/src/event-loop.lisp`（FR-311依存）
...
- **対象**: 新規`packages/backend/runtime/src/ebr.lisp`, `packages/backend/runtime/src/gc.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/hazard.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/lockfree.lisp`（FR-320/321依存）
...
- **対象**: 新規`packages/engine/vm/src/vm-simd.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`
- **現状**: SIMDレジスタ型・命令なし
...
- **対象**: `packages/frontend/expand/src/macros-stdlib.lisp`, 新規`packages/backend/runtime/src/parallel.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/fiber.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/engine/compile/src/cps.lisp`, `packages/frontend/expand/src/macros-stdlib.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/deadlock.lisp`
- **現状**: ロック順序検証なし
...
- **対象**: `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/runtime/src/scheduler.lisp`
...
- **対象**: `packages/engine/vm/src/vm.lisp`, 新規`packages/engine/vm/src/atomics.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/foundation/mir/src/target.lisp`, `packages/backend/emit/src/x86-64-codegen.lisp`, `packages/backend/emit/src/aarch64-codegen.lisp`
...
- **対象**: `packages/engine/vm/src/vm.lisp`, `packages/backend/runtime/src/runtime.lisp`
...
- **対象**: `packages/backend/runtime/src/runtime.lisp`, 新規`packages/backend/runtime/src/signals.lisp`
...
- **対象**: `packages/backend/runtime/src/runtime.lisp`, 新規`packages/backend/runtime/src/mmap.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/sync.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: `packages/backend/runtime/src/sync.lisp`（FR-370依存）
...
- **対象**: `packages/backend/runtime/src/sync.lisp`（FR-370/371依存）
...
- **対象**: `packages/frontend/expand/src/macros-stdlib.lisp`, `packages/backend/runtime/src/sync.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/rcu.lisp`（FR-320 EBRと相補的）
...
- **対象**: `packages/backend/runtime/src/sync.lisp`（FR-370の内部実装として使用可能）
...
- **対象**: 新規`packages/backend/runtime/src/sync.lisp`
...
- **対象**: `packages/backend/runtime/src/sync.lisp`, `packages/backend/runtime/src/scheduler.lisp`（FR-291 priority scheduler依存）
...
- **対象**: `packages/engine/compile/src/cps.lisp`, `packages/frontend/expand/src/macros-stdlib.lisp`, `packages/engine/vm/src/vm.lisp`
...
- **対象**: 新規`packages/backend/emit/src/gpu-codegen.lisp`, 新規`packages/backend/runtime/src/gpu.lisp`
...
- **対象**: `packages/backend/emit/src/wasm-codegen.lisp`（`docs/wasm.md`参照）, 新規`packages/backend/emit/src/wasm-threads.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/stream.lisp`（FR-282チャネル・FR-281 async依存）
...
- **対象**: `packages/frontend/expand/src/macros-stdlib.lisp`, `packages/engine/compile/src/cps.lisp`（FR-341スタックレスコルーチン・FR-281 async依存）
...
- **対象**: 新規`packages/backend/runtime/src/context.lisp`, `packages/backend/runtime/src/scheduler.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/cluster.lisp`（FR-290アクターモデル依存）
...
- **対象**: 新規`packages/backend/runtime/src/crdt.lisp`（FR-430分散アクター依存）
...
- **対象**: 新規`packages/backend/runtime/src/consensus.lisp`（FR-430分散アクター・FR-283 Future依存）
- **現状**: 分散状態機械・リーダー選出なし
...
- **対象**: `packages/backend/runtime/src/heap.lisp`, 新規`packages/backend/runtime/src/allocator.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/topology.lisp`, `packages/backend/runtime/src/scheduler.lisp`
...
- **対象**: `packages/backend/runtime/src/fiber.lisp`（FR-340依存）, `packages/backend/runtime/src/scheduler.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/mvcc.lisp`（FR-345アトミック・FR-320 EBR依存）
...
- **対象**: `packages/backend/runtime/src/task.lisp`（FR-280依存）, `packages/engine/vm/src/conditions.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/qsbr.lisp`（FR-380 RCUと選択的補完）
...
- **対象**: `packages/backend/runtime/src/io-uring.lisp`（FR-310依存）, 新規`packages/backend/runtime/src/zerocopy.lisp`
...
- **対象**: 新規`packages/backend/runtime/src/ratelimit.lisp`（FR-282チャネル・FR-312タイマー依存）
...
- **対象**: 新規`packages/backend/runtime/src/spsc.lisp`（FR-345アトミック依存）
...
- **対象**: 新規`packages/backend/runtime/src/parallel-algo.lisp`（FR-332並列配列操作・FR-258 work-stealing依存）
...
- **対象**: `packages/backend/runtime/src/parallel-algo.lisp`（FR-470と同一ファイル）
...
- **対象**: `packages/backend/runtime/src/parallel-algo.lisp`, `packages/backend/runtime/src/scheduler.lisp`（FR-258 work-stealing依存）
...
- **対象**: `packages/backend/runtime/src/heap.lisp`, `packages/backend/emit/src/aarch64-codegen.lisp`
- **現状**: AArch64バックエンドあり（`packages/backend/emit/src/aarch64.lisp`）。MTE命令（`IRG`/`STG`/`LDG`/`ADDG`）の生成なし。並行UAF（Use-After-Free）検出なし
...
- **対象**: 新規`packages/backend/runtime/src/otel.lisp`（FR-412 Context Propagation依存）
...
- **対象**: 新規`packages/backend/runtime/src/clock.lisp`（FR-430分散アクター依存）
...
- **対象**: 新規`packages/backend/runtime/src/log.lisp`（FR-462 SPSC Ring Buffer・FR-412 Context依存）
