...
- **対象**: `packages/runtime/src/gc.lisp`, `packages/runtime/src/heap.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/runtime/src/gc.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/vm/src/strings.lisp`, `packages/vm/src/symbols.lisp`, `packages/runtime/src/heap.lisp`
...
- **対象**: `packages/vm/src/strings.lisp`, `packages/runtime/src/heap.lisp`
...
- **対象**: `packages/vm/src/primitives.lisp`, `packages/vm/src/vm-execute.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/vm/src/symbols.lisp`, `packages/vm/src/vm-execute.lisp`, `src/package.lisp`
...
- **対象**: `packages/optimize/src/optimizer.lisp`, `packages/compile/src/cps.lisp`
...
- **対象**: `packages/emit/src/x86-64-codegen.lisp`, `packages/mir/src/target.lisp`
...
- **対象**: `packages/vm/src/vm-clos.lisp`, `packages/vm/src/vm-execute.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/vm/src/vm.lisp`, `packages/runtime/src/heap.lisp`, `packages/vm/src/vm-clos.lisp`
...
- **対象**: `packages/type/src/`, `packages/compile/src/codegen.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/binary/src/macho.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/optimize/src/optimizer.lisp`, 新規 `src/analysis/datalog.lisp`
...
- **対象**: `packages/type/src/`, `packages/runtime/src/heap.lisp`
...
- **対象**: `packages/optimize/src/optimizer.lisp`, `packages/expand/src/expander.lisp`
...
- **対象**: `packages/vm/src/vm-execute.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/emit/src/aarch64.lisp`, `packages/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/compile/src/codegen.lisp`, `packages/emit/src/x86-64-codegen.lisp`, `packages/binary/src/macho.lisp`
...
- **対象**: `packages/compile/src/codegen.lisp`, `packages/cli/src/main.lisp`, `packages/binary/src/macho.lisp`
...
- **対象**: `src/package.lisp`, `packages/compile/src/codegen.lisp`, `packages/vm/src/symbols.lisp`
...
- **対象**: `packages/vm/src/primitives.lisp`, `packages/emit/src/x86-64-codegen.lisp`, `packages/emit/src/aarch64.lisp`
...
- **対象**: 新規 `src/numeric/interval.lisp`, `packages/type/src/`
...
- **対象**: `src/package.lisp`, `packages/expand/src/expander.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/parse/src/lexer.lisp`, `packages/expand/src/expander.lisp`
...
- **対象**: `packages/parse/src/cl/parser.lisp`, `packages/compile/src/codegen.lisp`, `packages/expand/src/expander.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/expand/src/expander.lisp`
...
- **対象**: `packages/vm/src/io.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/vm/src/conditions.lisp`, `packages/vm/src/vm-execute.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/vm/src/io.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/type/src/`, `packages/vm/src/conditions.lisp`
...
- **対象**: `packages/type/src/`, `packages/optimize/src/optimizer.lisp`
...
- **対象**: `packages/expand/src/expander.lisp`, `packages/expand/src/macros-stdlib.lisp`
...
- **対象**: `packages/optimize/src/optimizer.lisp`, `packages/compile/src/codegen.lisp`, `packages/binary/src/macho.lisp`
...
- **対象**: `packages/runtime/src/gc.lisp`, `packages/vm/src/vm-execute.lisp`, `src/ffi/`
...
- **対象**: `packages/type/src/`, `src/package.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/expand/src/macros-stdlib.lisp`, `packages/expand/src/expander.lisp`
...
- **対象**: `packages/expand/src/macros-stdlib.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/vm/src/symbols.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/parse/src/cl/parser.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/parse/src/lexer.lisp`
...
- **対象**: `src/ffi/`, `packages/compile/src/codegen.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `src/ffi/`, `packages/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/vm/src/io.lisp`, `packages/cli/src/main.lisp`, 新規 `src/platform/`
...
- **対象**: `packages/compile/src/codegen.lisp`, `packages/binary/src/macho.lisp`, `packages/cli/src/main.lisp`
...
- **対象**: `packages/vm/src/strings.lisp`, `packages/emit/src/x86-64-codegen.lisp`
...
- **対象**: 新規 `src/crypto/random.lisp`, `packages/vm/src/vm-execute.lisp`
...
- **対象**: `packages/binary/src/macho.lisp`, `packages/cli/src/main.lisp`, `packages/emit/src/x86-64-codegen.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/emit/src/x86-64-codegen.lisp`, `packages/compile/src/codegen.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/emit/src/`, `packages/vm/src/io.lisp`
...
- **対象**: `packages/cli/src/main.lisp`, `packages/type/src/`, `src/docs/extractor.lisp`
- **現状**: 型推論（FR-type系）の結果はコンパイル時のみ利用。推論された型シグネチャの外部文書化・表示なし
- **内容**: `./cl-cc show-types packages/compile/src/codegen.lisp` で推論済み型シグネチャを一覧表示。`./cl-cc check-types src/` で型エラーのみを報告（コンパイルせず）。型シグネチャをFR-902（docstring抽出）に自動付加。`(cl-cc:print-inferred-type fn)` でREPLから型を確認。Haskell `:type` / TypeScript `--declaration` / mypy `--show-column-numbers` と同等
