...
- **対象**: `packages/type/type/src/inference.lisp`, `packages/engine/vm/src/primitives.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/concurrency.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/security.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/regions.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/capabilities.lisp`
...
- **対象**: `packages/engine/compile/src/codegen.lisp`, REPL (`cli/src/main.lisp`)
...
- **対象**: 新ファイル `packages/type/type/src/generics.lisp`
...
- **対象**: `packages/type/type/src/effects.lisp` (FR-401 の拡張)
...
- **対象**: `packages/type/type/src/parser.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/staging.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/binding-time.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/optics.lisp`
...
- **対象**: `packages/type/type/src/typeclasses.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/sized.lisp`
...
- **対象**: `packages/type/type/src/coinductive.lisp` (FR-1204 の余帰納型と連携)
...
- **対象**: 新ファイル `packages/type/type/src/props.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/pcc.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/tactics.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/hott.lisp`
...
- **対象**: `packages/type/type/src/dependent.lisp` (FR-303 の依存型実装に必要)
...
- **対象**: 新ファイル `packages/type/type/src/serialization.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/async.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/channels.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/actors.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/stm.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/coroutines.lisp`
- **内容**: 中断・再開可能な計算の型
...
- **対象**: 新ファイル `packages/type/type/src/simd.lisp`
...
- **対象**: `packages/type/type/src/subtyping.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/units.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/intervals.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/tensors.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/smt.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/regex.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/quantum.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/probabilistic.lisp`
- **内容**: 確率分布を型として扱う
...
- **対象**: 新ファイル `packages/type/type/src/ad.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/hardware.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/config.lisp`
- **内容**: 設定ファイルの型を静的に検証
...
- **対象**: `packages/type/type/src/props.lisp` (FR-2001 Curry-Howard の拡張)
...
- **対象**: 新ファイル `packages/type/type/src/synthesis.lisp`
...
- **対象**: `packages/type/type/src/linear-logic.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/complexity-types.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/path-dependent.lisp`
...
- **対象**: `packages/type/type/src/utils.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/routing.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/qtt.lisp`
...
- **対象**: 新ファイル `packages/type/type/src/graded.lisp`
...
- **対象**: `packages/type/type/src/effects.lisp` (FR-401 の代替実装)
...
- **対象**: `packages/type/type/src/dependent.lisp` (FR-303 の依存型実装に必須)
...
- **対象**: 新ファイル `packages/type/type/src/cic.lisp`
