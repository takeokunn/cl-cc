...
;;; vm-bridge.lisp — *vm-host-bridge-functions*, vm-register-host-bridge,
;;;                  hash-table-values, slot-definition-*, generic-function-*,
;;;                  package introspection helpers, rt-plist-put,
;;;                  string-to-octets/octets-to-string, %get-documentation,
;;;                  and the bootstrap vm-register-host-bridge dolist.
