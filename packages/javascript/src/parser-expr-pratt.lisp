;;;; packages/javascript/src/parser-expr-pratt.lisp — JS Pratt Parser + Complex Expressions
;;;;
;;;; Covers: parenthesized expression / arrow functions, async expressions,
;;;; class expressions, dynamic import(), main Pratt climbing loop,
;;;; and assignment expression lowering.
;;;;
;;;; Load order: after parser-expr.lisp (which provides js-parse-primary,
;;;; js-parse-postfix, js-parse-unary, and the Pratt precedence table).
