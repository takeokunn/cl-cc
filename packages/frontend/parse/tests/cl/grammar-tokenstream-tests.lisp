...
(deftest tok-to-cst-cases
  "%tok-to-cst converts lexer-token to cst-token; returns nil for nil input."
...
(deftest make-list-cst-cases
  "%make-list-cst: creates cst-interior with kind/span; stores children list."
...
(deftest parse-cl-source-cases
  "parse-cl-source: integer/symbol/list → non-empty list; empty string → empty list."
