;;;; packages/ast/src/package.lisp - CL-CC AST Package
;;;;
  ...
  (:export
   ...
   #:ast-slot-reader #:ast-slot-writer #:ast-slot-accessor
    ...
    #:ast-defclass-name #:ast-defclass-superclasses
      ...
      #:ast-defclass-sealed #:ast-defclass-php-kind
      #:ast-defclass-php-enum-type #:ast-defclass-php-enum-cases
   ...
   #:ast-error
   ;; Closure / free-variable / escape analysis (closure.lisp)
