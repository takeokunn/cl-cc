...
(deftest cc-x86-64-registers
  ...
  (assert-equal 6 (length (cl-cc::cc-arg-registers cl-cc/emit::*x86-64-calling-convention*)))
  (assert-eq :rdi (first (cl-cc::cc-arg-registers cl-cc/emit::*x86-64-calling-convention*)))
...
(deftest cc-aarch64-registers
  ...
  (assert-equal 8 (length (cl-cc::cc-arg-registers cl-cc/emit::*aarch64-calling-convention*)))
  (assert-eq :x0 (first (cl-cc::cc-arg-registers cl-cc/emit::*aarch64-calling-convention*)))
