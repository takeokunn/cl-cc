...
(deftest wasm-ir-struct-construction-cases
  "wasm-field: default/explicit types; wasm-import/export store all fields."
...
(deftest wasm-ir-type-construction-cases
  "wasm-func-type/struct-type/array-type/type-entry all store their fields correctly."
...
(deftest wasm-ir-definition-cases
  "wasm-global-def and wasm-local each store all their fields correctly."
...
(deftest wasm-ir-add-operations-cases
  "add-function assigns monotone indices; add-global assigns index, registers name, handles unnamed."
  (let ((mod (cl-cc/emit::make-empty-wasm-module))
...
(deftest wasm-ir-reg-and-naming-cases
  "vm-global-wat-name prefixes with $g_; reg-to-local is idempotent and allocates sequentially."
