;;;; packages/backend/emit/src/x86-64-encoding-instrs.lisp - x86-64 Instruction Emitters
;;;
;;; Individual instruction emit functions: MOV, ADD, SUB, IMUL, CMP, PUSH, POP,
;;; RET, CALL, JMP/JE, TEST, XMM scalar-double (MOVSD/ADDSD/SUBSD/MULSD/DIVSD),
;;; MOVQ, POPCNT, BSR.
;;;
