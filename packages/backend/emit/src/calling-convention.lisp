;;;; packages/backend/emit/src/calling-convention.lisp - Calling Convention Definitions
;;;
...
(defstruct (calling-convention (:conc-name cc-))
  ...
  (fp-arg-registers nil :type list)
  (return-register nil)
  (fp-return-register nil)
...
(defvar *x86-64-calling-convention*
  (make-calling-convention
    ...
    :fp-arg-registers '(:xmm0 :xmm1 :xmm2 :xmm3 :xmm4 :xmm5 :xmm6 :xmm7)
    :return-register :rax
    :fp-return-register :xmm0
...
(defvar *aarch64-calling-convention*
  (make-calling-convention
    ...
    :fp-arg-registers '(:v0 :v1 :v2 :v3 :v4 :v5 :v6 :v7)
    :return-register :x0
    :fp-return-register :v0
