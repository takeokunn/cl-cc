;;;; packages/mir/src/target.lisp — Unified Target Descriptor
;;;
...
(defstruct (target-desc (:conc-name target-))
  ...
  (fp-arg-regs     nil  :type list)     ; floating-point argument-passing registers
  (fp-ret-reg      nil)                 ; primary floating-point return-value register
...
(defvar *x86-64-target*
  (make-target-desc
    ...
    :ret-reg      :rax
    :fp-arg-regs  '(:xmm0 :xmm1 :xmm2 :xmm3 :xmm4 :xmm5 :xmm6 :xmm7)
    :fp-ret-reg   :xmm0
    :callee-saved '(:rbx :r12 :r13 :r14 :r15)
    :scratch-regs '(:r11 :rsp :rbp)      ; r11=scratch, rsp=stack pointer, rbp=frame pointer
    :stack-alignment 16
...
(defvar *aarch64-target*
  (make-target-desc
    ...
    :ret-reg      :x0
    :fp-arg-regs  '(:v0 :v1 :v2 :v3 :v4 :v5 :v6 :v7)
    :fp-ret-reg   :v0
    :callee-saved '(:x19 :x20 :x21 :x22 :x23 :x24 :x25 :x26 :x27 :x28)
    :scratch-regs '(:x16 :x18 :x29 :x30) ; x16=scratch, x18=platform, x29=frame, x30=link
    :stack-alignment 16
...
(defvar *riscv64-target*
  (make-target-desc
    ...
    :ret-reg      :a0
    :fp-arg-regs  '(:fa0 :fa1 :fa2 :fa3 :fa4 :fa5 :fa6 :fa7)
    :fp-ret-reg   :fa0
