...
(defun rt-condition-wait (cv m &key timeout) (sb-thread:condition-wait (rt-condition-variable-waitqueue cv) (rt-mutex-host-mutex m) :timeout (or timeout 1e6)))
(defun rt-condition-notify (cv) (sb-thread:condition-notify (rt-condition-variable-waitqueue cv)))
(defun rt-condition-notify-all (cv) (sb-thread:condition-broadcast (rt-condition-variable-waitqueue cv)))
